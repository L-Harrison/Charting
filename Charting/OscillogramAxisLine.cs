...
namespace Charting
{
    public abstract class OscillogramAxisLine : IDraggable, IPlottable, IHasLine, IHasColor
    {
        /// <summary>
        ...
        public OscillogramAxisLine(bool isHorizontal)
        {
        ...
        /// </summary>
        public Func<Coordinate, Coordinate> MovePointFunc { get; set; } = ( moveTo) => moveTo;
        /// <summary>
        ...
        public void DragTo(double coordinateX, double coordinateY, bool fixedSize)
        {
            ...
            Coordinate actual = MovePointFunc( snapped);
